...
<form action="{{ route('dashboard', [], false) }}" method="GET">    <div class="form-item">
  ...
  <div style="margin-top: 20px; text-align: center;">
    ...
    <a href="{{ route('dashboard', [], false) }}" style="color: white; margin-right: 15px;">Dashboard</a>
    
    <a href="{{ route('store.create', [], false) }}" style="color: white; margin-right: 15px;">Create Store</a>
    
    <a href="{{ route('store.index', [], false) }}" style="color: white;">All Stores</a>

</div>
  
  <script src="main.js">const root = document.documentElement;
